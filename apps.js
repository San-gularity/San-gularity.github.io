...
export const APPS = [
  ...
  },
  {
    ...
    url: './resume.pdf',
    icon: '📄',
    blurb: 'One page, PDF, kept current. Data engineering, backend and whatever the games taught me.',
    status: 'none',
    kind: 'PDF',
    year: 2026,
    theme: { bg: '#111827', ink: '#f3f4f6', muted: '#9ca3af', accent: '#34d399' },
    links: [
      { label: 'LinkedIn', url: 'https://linkedin.com/in/sanath0307' },
    ],
  },
  {
    name: 'Split the Bill',
